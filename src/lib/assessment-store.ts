...
const MOCK: Omit<ProjectRecord, "id" | "createdAt" | "weights">[] = [
  {
    ...
    scores: {
      ...
      customerBrandValue: 4,
      dataAvailability: true,
      qualityAccessibility: 5,
      integrationFeasibility: 5,
      modelPerformance: 5,
      scalability: 5,
      finOps: 5,
      userReadiness: 4,
  ...
  },
  {
    ...
    scores: {
      ...
      customerBrandValue: 4,
      dataAvailability: true,
      qualityAccessibility: 1,
      integrationFeasibility: 1,
      modelPerformance: 3,
      scalability: 2,
      finOps: 3,
      userReadiness: 3,
